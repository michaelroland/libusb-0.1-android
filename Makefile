...
##am__objects_1 =  \
##	darwin.lo
##am__objects_1 = bsd.lo
am__objects_1 = linux.lo
...
DEP_FILES = ./$(DEPDIR)/bsd.Plo ./$(DEPDIR)/darwin.Plo \
	./$(DEPDIR)/descriptors.Plo ./$(DEPDIR)/error.Plo \
	./$(DEPDIR)/linux.Plo ./$(DEPDIR)/usb.Plo \
	./$(DEPDIR)/usbpp.Plo
...
ACLOCAL = ${SHELL} /tmp/libusb-0.1.12/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /tmp/libusb-0.1.12/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /tmp/libusb-0.1.12/missing --run autoconf
AUTOHEADER = ${SHELL} /tmp/libusb-0.1.12/missing --run autoheader
AUTOMAKE = ${SHELL} /tmp/libusb-0.1.12/missing --run automake-1.8
AWK = gawk
BIGENDIAN = 0
BSD_API = 0
BSD_API_FALSE = 
...
LT_RELEASE = 0.1
LT_REVISION = 4
MAKEINFO = ${SHELL} /tmp/libusb-0.1.12/missing --run makeinfo
OBJEXT = o
OSLIBS = 
PACKAGE = libusb
PACKAGE_BUGREPORT = 
...
infodir = ${prefix}/info
install_sh = /tmp/libusb-0.1.12/install-sh
